...
public class RiderPannelPopUp : MonoBehaviour
{
    ...
    public float startYPosition = 1084f; // Starting Y position of the image below the screen
    public float endYPosition = 606f; // Ending Y position of the image when fully visible
